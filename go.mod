module github.com/vogo/grpcapi
...
require (
	...
	github.com/go2s/o2s v1.1.3-0.20190125064339-08881cbbd592
	...
	github.com/vogo/clog v0.0.0-20181025013138-1db5bea1f07b
	...
	gopkg.in/session.v3 v3.1.2 // indirect
