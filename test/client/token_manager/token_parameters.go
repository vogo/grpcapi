...
type TokenParams struct {
	...
	/*Body*/
	Body *models.GrpcapiTokenRequest
...
func (o *TokenParams) WithBody(body *models.GrpcapiTokenRequest) *TokenParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the token params
func (o *TokenParams) SetBody(body *models.GrpcapiTokenRequest) {
	o.Body = body
}
