...
type EchoParams struct {
	...
	/*Body*/
	Body *models.GrpcapiEchoRequest
...
func (o *EchoParams) WithBody(body *models.GrpcapiEchoRequest) *EchoParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the echo params
func (o *EchoParams) SetBody(body *models.GrpcapiEchoRequest) {
	o.Body = body
}
